...
export const en = {
  ...
  'photo.noteHint':
    'Cooking method and hidden oils matter most — the estimate trusts your note over the photo.',
  ...
  'photo.total': 'Total',
  'photo.sourceDb': 'USDA',
  'photo.sourceDbHint': 'Macros come from the USDA nutrition database.',
  'photo.sourceAi': 'AI estimate',
  'photo.sourceOff': 'Open Food Facts',
  'photo.unresolvedHint':
    'Not found in the nutrition database — these numbers are the AI’s own guess.',
  ...
  // My Recipes (the user's own dishes)
  'recipes.title': 'My Recipes',
  'recipes.searchPlaceholder': 'Search your recipes',
  'recipes.add': 'Add recipe',
  'recipes.emptyTitle': 'No recipes yet',
  'recipes.emptyBody':
    'Build the dishes you cook from their ingredients, and log a portion by weight whenever you eat one.',
  'recipes.noMatches': 'No recipes match your search.',
  'recipes.loading': 'Loading your recipes…',
  'recipes.loadError': "Couldn't load your recipes.",
  'recipes.newTitle': 'New recipe',
  'recipes.editTitle': 'Edit recipe',
  'recipes.name': 'Name',
  'recipes.namePlaceholder': 'e.g. Moussaka',
  'recipes.mode': 'Nutrition',
  'recipes.modeIngredients': 'From ingredients',
  'recipes.modeManual': 'Enter totals',
  'recipes.ingredients': 'Ingredients',
  'recipes.addIngredient': 'Add ingredient',
  'recipes.noIngredients': 'No ingredients yet. Add the first one to see the totals.',
  'recipes.removeIngredient': 'Remove {name}',
  'recipes.ingredientGrams': 'Grams of {name}',
  'recipes.totalWeight': 'Total weight (g)',
  'recipes.totalWeightOptional': 'Total weight (g, optional)',
  'recipes.totalWeightHint':
    'Leave empty to use the sum of the ingredients. Set it to the cooked weight if the dish loses water.',
  'recipes.totals': 'Whole recipe',
  'recipes.per100g': 'Per 100 g',
  'recipes.save': 'Save recipe',
  'recipes.delete': 'Delete recipe',
  'recipes.deleteHint': 'Diary entries keep the values they were logged with.',
  'recipes.editAria': 'Edit {name}',
  'recipes.recipeLabel': 'My recipe',
  'recipes.outOfRange': 'Those totals are too high for that weight. Check the total weight.',
...
export const bg: Record<TranslationKey, string> = {
  ...
  'scan.denied':
    'Достъпът до камерата е блокиран. Разреши достъп до камерата в настройките на браузъра и опитай отново.',
  ...
  'photo.noteHint':
    'Начинът на приготвяне и скритите мазнини са най-важни — оценката се доверява на бележката ти повече, отколкото на снимката.',
  'photo.analyze': 'Оцени',
  ...
  'photo.total': 'Общо',
  'photo.sourceDb': 'USDA',
  'photo.sourceDbHint': 'Макросите са от хранителната база USDA.',
  'photo.sourceAi': 'Оценка от AI',
  'photo.sourceOff': 'Open Food Facts',
  'photo.unresolvedHint':
    'Не е намерено в базата с храни — тези стойности са собствена преценка на AI.',
  ...
  // My Recipes (the user's own dishes)
  'recipes.title': 'Моите рецепти',
  'recipes.searchPlaceholder': 'Търси в моите рецепти',
  'recipes.add': 'Добави рецепта',
  'recipes.emptyTitle': 'Още нямаш рецепти',
  'recipes.emptyBody':
    'Създай ястията, които готвиш, от техните съставки и записвай порция по тегло, когато хапнеш.',
  'recipes.noMatches': 'Няма съвпадения сред твоите рецепти.',
  'recipes.loading': 'Зареждане на рецептите…',
  'recipes.loadError': 'Рецептите не се заредиха.',
  'recipes.newTitle': 'Нова рецепта',
  'recipes.editTitle': 'Редакция на рецепта',
  'recipes.name': 'Име',
  'recipes.namePlaceholder': 'напр. Мусака',
  'recipes.mode': 'Изчисляване',
  'recipes.modeIngredients': 'По съставки',
  'recipes.modeManual': 'Общи стойности',
  'recipes.ingredients': 'Съставки',
  'recipes.addIngredient': 'Добави съставка',
  'recipes.noIngredients': 'Още няма съставки. Добави първата, за да видиш стойностите.',
  'recipes.removeIngredient': 'Премахни {name}',
  'recipes.ingredientGrams': 'Грамове {name}',
  'recipes.totalWeight': 'Общо тегло (г)',
  'recipes.totalWeightOptional': 'Общо тегло (г, незадължително)',
  'recipes.totalWeightHint':
    'Остави празно, за да се използва сборът от съставките. Задай теглото след готвене, ако ястието изпарява вода.',
  'recipes.totals': 'Цялата рецепта',
  'recipes.per100g': 'На 100 г',
  'recipes.save': 'Запази рецептата',
  'recipes.delete': 'Изтрий рецептата',
  'recipes.deleteHint': 'Записите в дневника запазват стойностите, с които са добавени.',
  'recipes.editAria': 'Редактирай {name}',
  'recipes.recipeLabel': 'Моя рецепта',
  'recipes.outOfRange': 'Стойностите са твърде високи за това тегло. Провери общото тегло.',
